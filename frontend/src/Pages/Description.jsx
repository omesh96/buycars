...
import { Button, Heading,Text } from '@chakra-ui/react'
 ...
 const Description = () => {
    ...
    useEffect(()=>{
        fetch(`http://localhost:8080/sellcar/getdatabyid/${id}`,{
         headers:{
                ...
                <div className="table1_div">
                    ...
                    <div className="table">
                        ...
                        <div className="flexbox">
                            ...
                            <Text fontSize='lg'>{specData.year ? specData.year : 2015}</Text>
                        </div>
                        <hr />
                        <div className="flexbox">
                        ...
                        <div className="flexbox">
                            ...
                            <Text fontSize='lg'>{specData.Number_of_accidents_reported}</Text>
                        </div>
                        <hr />
                        <div className="flexbox">
            ...
            <div className="table1_div">
                    ...
                    <div className="table">
                        ...
                        <div className="flexbox">
                            ...
                            {oemData.available_color && oemData.available_color.map((el,i)=>{
                                return <button key={i} className='colorbtn'>{el}</button>
                            })}
                        </div>
                        <hr />
                        <div className="flexbox">
