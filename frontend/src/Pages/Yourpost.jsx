...
const Yourpost = () => {
 ...
 const updateMyData=async()=>{
  ...
  <Select placeholder='Filter By Company' value={company} onChange={(e)=>handleCompanyData(e.target.value)}>
  ...
  <Select placeholder='Filter by Color' value={color} onChange={(e)=>handleColorData(e.target.value)}>
           ...
           <div className='posts'>
                {myPost && myPost.map((el)=>{
                    return <div className='galary' key={el._id}>
                        <img key={el._id} src={el.images} alt="posts" className='items' />
