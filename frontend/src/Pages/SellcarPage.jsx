...
const initData={
 ...
 const SellcarPage = () => {
  ...
  const {image,company,model,year,paint,Num_of_accident,Num_of_prev_buyers,Registration_place,KM_driven,Major_scratches,price}=inputData
 ...
 useEffect(()=>{
  ...
  if(url){
    setLoading(true)
     fetch("http://localhost:8080/sellcar/addcar",{
         method:"POST",
         headers:{
 ...
 const loadFile=(event)=>{
  ...
  return (
     ...
     <div className='carform'>
      ...
      <Select placeholder='Select Company' style={{backgroundColor:"tomato"}} value={company} name="company" onChange={handleChange}>
  ...
  <Input type='text' placeholder='ex- Wagno R, vitara Breza, i-10,safari,thar' value={model} name="model" onChange={handleChange } />

  <FormLabel>Year</FormLabel>
  <Input type='number' placeholder='ex- 2010,2021' value={year} name="year" onChange={handleChange} />
  ...
  <Input type='number' placeholder='ex- 1,2,3' value={Num_of_accident} name="Num_of_accident" onChange={handleChange} />
       </div>
       <div className='carform2'>
       <FormLabel>Number_of_previous_buyers</FormLabel>
      <Input type='number' placeholder='ex- 1,2,3....' value={Num_of_prev_buyers} name="Num_of_prev_buyers" onChange={handleChange} />
      <FormLabel>Registration_Place</FormLabel>
      <Input type='text' placeholder='ex- city name....' value={Registration_place} name="Registration_place" onChange={handleChange} />

  <FormLabel>KMs_on_Odometer</FormLabel>
  <Input type='number' placeholder='ex- 12000,15000....' value={KM_driven} name="KM_driven" onChange={handleChange} />

  <FormLabel>Major_Scratches</FormLabel>
  <Input type='number' placeholder='ex- 1,2,3....' value={Major_scratches} name="Major_scratches" onChange={handleChange}/>

  <FormLabel>price</FormLabel>
  <Input type='number' placeholder='ex- 500000,110000' value={price} name="price" onChange={handleChange} />
